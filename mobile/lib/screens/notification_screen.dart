...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget _buildNotificationItem(Map<String, dynamic> notif) {
    ...
    IconData getIcon() {
      switch (type) {
        case 'course_purchase': return Icons.shopping_bag_rounded;
        case 'exam_created': return Icons.assignment_rounded;
    ...
    Color getIconColor() {
      switch (type) {
        case 'course_purchase': return Colors.green;
        case 'exam_created': return Colors.blue;
