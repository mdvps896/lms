export default function ExamMonitoringSkeleton() {
    return (
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <div className="placeholder-glow">
                        <span className="placeholder col-3 mb-2" style={{ height: '40px', display: 'block' }}></span>
                        <span className="placeholder col-6" style={{ height: '32px', display: 'block' }}></span>
                    </div>
                </div>
                <div className="placeholder-glow">
